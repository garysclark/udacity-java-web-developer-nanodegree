...
public class NoteController {
	...
	public static final String DELETE_NOTE_ENDPOINT = "/note/delete";
	public static final String CREATE_NOTE_ENDPOINT = "/note/create";
	public static final String UPDATE_NOTE_ENDPOINT = "/note/update";
	...
	@PostMapping(CREATE_NOTE_ENDPOINT)
	...
	@PostMapping(UPDATE_NOTE_ENDPOINT)
	public String updateNote(@ModelAttribute Note note, RedirectAttributes redirectAttributes, Authentication authentication) {
	...
	@PostMapping(DELETE_NOTE_ENDPOINT)
